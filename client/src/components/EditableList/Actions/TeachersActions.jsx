...
import ModalAddTeacher from '../Modal/ActionModals/ModalCreateTeacher/ModalAddTeacher';

const TeachersActions = ({ students: teachers }) => {
    const [isOpen, setOpen] = useState(true);
    const [isModalAddTeacherOpen, setModalAddTeacherOpen] = useState(false);
    ...
    return (
        <>
            ...
            {/* <!-- AddStudentModal --> */}
            <ModalAddTeacher
                isModalOpen={isModalAddTeacherOpen}
                setModalOpen={setModalAddTeacherOpen}
            />
        </>
    );
};
